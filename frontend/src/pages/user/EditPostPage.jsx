...
function EditPostPage() {
    ...
    const loadPost = async () => {
        try {
            setLoading(true);
            const post = await postService.getUserPostById(id);
            setFormData({
                title: post.title || '',
    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            setUploading(true);
            const data = await postService.uploadUserImage(file);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await postService.updateUserPost(id, {
    ...
    return (
        <div className="post-editor-page">
            <header className="page-header">
                <div>
                    <Link to="/user/posts" className="back-link">← Back to My Posts</Link>
                    <h1>Edit Post</h1>
