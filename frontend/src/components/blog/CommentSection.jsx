...
function CommentSection({ postId }) {
    ...
    const loadComments = async () => {
        try {
            ...
            const data = await commentService.getApprovedComments(postId);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (authUser) {
                await commentService.submitUserComment(
                    postId,
                    formData.content
                );
                ...
                // ✅ FIXED: correct service method
                await commentService.submitGuestComment(
                    postId,
                    formData.guest_name,
                ...
                setSuccess(
                    '✅ Your comment has been submitted! It will appear after admin approval.'
                );
            }
